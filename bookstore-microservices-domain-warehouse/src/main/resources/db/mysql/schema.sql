...
CREATE OR REPLACE PROCEDURE create_default_product_if_not_exists()
begin
    declare v_cnt INT;
    SELECT 'Checking if product exists...' AS log_message;
    ...
    if v_cnt=0 then
        ...
        SELECT 'Product does not exist. Inserted successfully...' AS log_message;
    else
        SELECT 'Product exists...' AS log_message;
    end if;
end; $$

CREATE OR REPLACE PROCEDURE create_default_specification_if_not_exists()
begin
    declare v_cnt INT;
    SELECT 'Checking if specification exists...' AS log_message;
    select count(*) into v_cnt from specification;
    if v_cnt=0 then
        ...
        INSERT INTO specification
        VALUES (69, '装帧', '在线', 8);
        SELECT 'Specification does not exist. Inserted successfully...' AS log_message;
    else
        SELECT 'Specification exists...' AS log_message;
    end if;
end; $$

CREATE OR REPLACE PROCEDURE create_default_advertisement_if_not_exists()
begin
    declare v_cnt INT;
    SELECT 'Checking if advertisement exists...' AS log_message;
    select count(*) into v_cnt from advertisement;
    if v_cnt=0 then
        ...
        SELECT 'Advertisement does not exist. Inserted successfully...' AS log_message;
    else
        SELECT 'Advertisement exists...' AS log_message;
    end if;
end; $$

CREATE OR REPLACE PROCEDURE create_default_stockpile_if_not_exists()
begin
    declare v_cnt INT;
    SELECT 'Checking if stockpile exists...' AS log_message;
    select count(*) into v_cnt from stockpile;
    if v_cnt=0 then
        ...
        INSERT INTO stockpile
        VALUES (8, 30, 0, 8);
        SELECT 'Stockpile does not exist. Inserted successfully...' AS log_message;
    else
        SELECT 'Stockpile exists...' AS log_message;
    end if;
end; $$